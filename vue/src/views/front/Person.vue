<template>
  <div class="front-container" style="width: 50%">
    <div class="card" style="padding: 20px">
      ...
      <el-form ref="formRef" :model="data.user" label-width="80px" style="padding-right:30px" :rules="data.rules">
        <el-form-item label="头像" prop="avatar">
          <el-upload
            ...
            <img v-if="data.user.avatar" :src="data.user.avatar" class="avatar" alt="头像" />
        ...
        <el-form-item prop="account" label="账号余额">
