<template>
  <div class="front-container">
    <div style="font-size: 20px; font-weight: bold; margin-bottom: 15px">我收藏的商品（{{ data.total }}）</div>
      <el-row :gutter="20">
        <el-col :span="6" v-for="item in data.tableData" :key="item.id ">
          <div @click="router.push('/front/goodsDetail?id=' + item.goodsId)" class="card"
               style="cursor: pointer; width: 100%; border-radius: 0; padding:5px; margin-bottom: 20px">
            <img :src="item.goodsImg" alt="" style="width: 100%; height: 180px; border-radius: 5px 5px 0 0" />
            <div style="padding: 5px">
              <div class="line1" style="font-size: 18px; margin-bottom: 10px">
                {{ item.goodsName }}
              </div>
