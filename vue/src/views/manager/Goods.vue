  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 5px;">
      ...
      <el-select style="width: 300px; margin-right: 10px" v-model="data.categoryId" placeholder="请选择商品分类">
        <el-option label="全部" :value="null" key="all"/>
      ...
      <el-table tooltip-effect="dark myEff" :data="data.tableData" stripe>
        ...
        <el-table-column label="图片" width="100">
            <template #default="scope">
              <el-image :src="scope.row.img" :preview-src-list="[scope.row.img]" style="width: 100px; height: 80px;"></el-image>
            </template>
        </el-table-column>
        ...
        <el-table-column prop="content" label="详情"  >
          <template #default="scope">
            <el-button style="width:40px"  type="primary" @click="view(scope.row.content)">查看</el-button>
          </template>
        </el-table-column>
    ...
    <el-dialog title="商品信息" width="55%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
